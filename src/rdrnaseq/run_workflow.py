...
from rdrnaseq.stages import Count, Dashboard, Fraser, Outrider, Somalier, TrimAlignRNA, VariantSpliceMatch
...
def cli_main() -> None:
    ...
    stages = [TrimAlignRNA, Count, Somalier, Fraser, Outrider, VariantSpliceMatch, Dashboard]
