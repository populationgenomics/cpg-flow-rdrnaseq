...
from rdrnaseq.stages import Count, Dashboard, Fraser, Outrider, TrimAlignRNA, VariantAnnotation
...
def cli_main() -> None:
    ...
    stages = [TrimAlignRNA, Count, Fraser, Outrider, VariantAnnotation, Dashboard]
